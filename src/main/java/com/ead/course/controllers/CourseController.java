...
public class CourseController {
    ...
    public ResponseEntity<Object> saveCourse(@RequestBody CourseDto courseDto, Errors errors) {
        ...
        courseValidator.validate(courseDto, errors); // Chama a validação que criamos, para garantir que apenas instrutores possam criar novos cursosr
        if (errors.hasErrors()) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(errors.getAllErrors()); // Passa a lista de erros no body
        }
